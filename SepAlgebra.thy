...
section \<open>First lemmata\<close>
...
section \<open>Succ is an order\<close>
...
section \<open>Core (pure) and stabilize (stable)\<close>
...
section \<open>Lifting to sets\<close>
